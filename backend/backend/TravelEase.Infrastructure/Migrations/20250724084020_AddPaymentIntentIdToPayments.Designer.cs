...
namespace TravelEase.Infrastructure.Migrations
{
    ...
    [Migration("20250724084020_AddPaymentIntentIdToPayments")]
    partial class AddPaymentIntentIdToPayments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelEase.Domain.Aggregates.Images.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelEase.Domain.Aggregates.Payments.Payment", b =>
                {
                    b.HasOne("TravelEase.Domain.Aggregates.Bookings.Booking", "Booking")
                        .WithOne("Payment")
                        .HasForeignKey("TravelEase.Domain.Aggregates.Payments.Payment", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
